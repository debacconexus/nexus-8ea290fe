...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Library Patron Coordination System";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Patron";
process.env.TABLE_NAME = process.env.TABLE_NAME || "patron_records";
'use strict';
